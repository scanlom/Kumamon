...
from lib_config import config_email_server
from lib_config import config_email_port
from lib_config import config_email_user
from lib_config import config_email_password
